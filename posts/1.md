...
- Odin 언어로 작성된 게임 엔진 – 현재는 2D만 지원
- 멀티 플랫폼: Windows, Linux, Android, (웹 지원 추가중)
- 그래픽: Vulkan 1.1+ (데스크톱),(Android), Wepgpu (웹)
- 창/입력: windows api, xlib, wayland  (데스크톱), Android NDK (모바일), 웹(odin.js, wasm)
...
- **platform_xx.odin**: 데스크톱 창 관리 및 입력 처리
...
| 기하       | geometry.odin            | 벡터 그래픽 조립          |
| 글꼴       | font.odin                | geometry.odin과 연계, 글자 shape로 조립        |
