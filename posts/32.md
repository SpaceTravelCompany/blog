...
- **Vulkan Specification – 10.3. Compute Pipelines**  
  https://docs.vulkan.org/spec/latest/chapters/computepipelines.html  
  (VkComputePipelineCreateInfo, VkPipelineShaderStageCreateInfo)

- **Vulkan Specification – VkComputePipelineCreateInfo**  
  https://docs.vulkan.org/refpages/latest/refpages/source/VkComputePipelineCreateInfo.html  
  (flags, stage, layout 상세)

- **Vulkan Specification – 12. Shader Execution** (Workgroup, memory model)  
  https://docs.vulkan.org/spec/latest/chapters/shaders.html

- **Vulkan Specification – VkCmdDispatch**  
  https://docs.vulkan.org/refpages/latest/refpages/source/vkCmdDispatch.html  
  (GroupCountX/Y/Z)

- **Vulkan Specification – VkCmdDispatchIndirect**  
